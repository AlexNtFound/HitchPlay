...
# ---------- 2. LiDAR driver ----------
launch 'source ~/ws_lidar/install/setup.bash; set -u; ros2 launch sllidar_ros2 view_sllidar_a2m12_nogui_launch.py'
# ---------- 3. static transform ----------
...
launch 'sudo cpufreq-set -g performance; source /opt/ros/jazzy/setup.bash; set -u; \
        cd ~/leo_ws/src/LeoRover-SLAM-ROS2; ros2 launch slam_toolbox online_async_launch.py use_sim_time:=false'
# ---------- 6. EKF localization ----------
